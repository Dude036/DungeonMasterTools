...
level_3 = [
    ...
    'Explosive Runes', 'Fear', 'Fireball', 'Flame Arrow', 'Fly',
    'Gaseous Form', 'Geas, Lesser', 'Glibness', 'Glyph of Warding',
    'Good Hope', 'Halt Undead', 'Haste', 'Heal Mount', 'Helping Hand',
    'Illusory Script', 'Inflict Serious Wounds', 'Invisibility Purge',
    ...
    'Frigid Touch', 'Ghostly Disguise', 'Ghoul Hunger', 'Id Insinuation I',
    'Mad Hallucination', 'Piercing Shriek', 'Secret Speech', 'Share Memory',
    'Symbol of Mirroring', 'Touch of Chaos', 'Touch of Evil', 'Touch of Good',
    'Touch of Law', 'Touch of Madness', 'Unnatural Lust', 'Unshakable Chill',
    'Water of Maddening'
]
level_4 = [
...
level_5 = [
    ...
    'Breath of Life', 'Call Lightning Storm', 'Charm Animal, Mass',
    'Cloudkill', 'Command, Greater', 'Commune', 'Cone of Cold',
    'Contact Other Plane', 'Control Winds', 'Cure Light Wounds, Mass',
    'Dispel Good', 'Dispel Law', 'Dispel Magic, Greater', 'Disrupting Weapon',
    'Dream', 'Elemental Body II', 'Fabricate', 'False Vision', 'Feeblemind',
    'Hallow', 'Heroism, Greater', 'Inflict Light Wounds, Mass',
    'Insect Plague', 'Interposing Hand', "Mage's Faithful Hound",
    "Mage's Private Sanctum", 'Magic Jar', 'Major Creation', 'Mind Fog',
    'Mirage Arcana', 'Mislead', 'Nightmare', 'Overland Flight', 'Passwall',
    'Permanency', 'Persistent Image', 'Planar Binding, Lesser', 'Plane Shift',
    'Plant Shape I', 'Polymorph', 'Prying Eyes', 'Raise Dead',
    'Righteous Might', 'Secret Chest', 'Seeming', 'Shadow Evocation',
    'Shadow Walk', 'Slay Living', 'Song of Discord', 'Spell Resistance',
    'Suggestion, Mass', 'Summon Monster V', "Summon Nature's Ally V",
    'Symbol of Pain', 'Symbol of Sleep', 'Telekinesis', 'Telepathic Bond',
    'Teleport', 'Transmute Mud to Rock', 'Transmute Rock to Mud',
    'True Seeing', 'Unhallow', 'Wall of Force', 'Wall of Stone',
    'Wall of Thorns', 'Waves of Fatigue', "Bard's Escape",
...
level_6 = [
    ...
    'Circle of Death', 'Cold Ice Strike', 'Contingency', 'Create Undead',
    ...
    'Hostile Juxtaposition, Greater', 'Walk through Space', 'Plague Storm',
    'Vengeful Outrage', 'Icy Prison', 'Id Insinuation IV', 'Lightning Arc',
    'Possess Object', 'Rapid Repair', 'Soothe Construct',
...
level_9 = [
    ...
    'Spell Immunity, Greater Communal', 'Icy Prison, Mass',
    'Overwhelming Presence', 'Polar Midnight', 'Symbol of Scrying',
