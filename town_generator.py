...
from masterwork import find_masterwork_traits_weapon, find_masterwork_traits_armor

townHTML = '<!DOCTYPE html><html><head><meta name="viewport" content="width=device-width" /><title></title><style>body'\
