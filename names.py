...
class Gillman:
    ...
    f1 = ['Nadia', 'Vivia', 'Tyene', 'Meri', 'Riva', 'Kelby', 'Nixie', 'Doria', 'Nerissa', 'Kailani', 'Taila', 'Leena',
          ...
          'Nixie', 'Noelani', 'Noelle', 'Nyneve', 'Oceane', 'Oceana', 'Oceane', 'Ondine', 'Oona', 'Orabel', 'Orabelle',
...
class Books(object):
    ...
    def Romance(self):
        r1 = ["admirer", "angel", "assistant", "beloved", "boy", "boyfriend", "colleague", "cook", "darling", "dear",
              "dearest", "duchess", "duke", "fiance", "flame", "foreigner", "friend", "girl", "girlfriend", "god",
...
class Restaurant(object):
    ...
    r3 = ["Abacus", "Acapella", "Ace", "After Dark", "Alpha", "Ambience", "Amigos", "Amuse", "Aqua", "Arch", "Aroma",
          ...
          "Whammy", "Whisperwind"]
    # Set 2
    r4 = ["Elegant", "Emeraude", "Epice", "Acide", "Acidule", "Affame", "Ambre", "Amer", "Ancien", "Antique",
          "Arctique", "Ardent", "Argente", "Bengale", "Bouillant", "Brulent", "Brillant", "Cotier", "Carre",
          "Chaleureux", "Charmant", "Chaud", "Chic", "Chouette", "Clair", "Cramoisi", "Dore", "Doux", "Fier", "Fou",
          "Frais", "Francais", "Gracieux", "Grec", "Harmonique", "Incarnat", "Incroyable", "Indien", "Italien",
          "Japonais", "Laitier", "Lunaire", "Magique", "Marocain", "Moderne", "Moelleux", "Ovale", "Peint", "Pimpant",
          "Polaire", "Prive", "Rare", "Releve", "Rose", "Sacre", "Sale", "Sauvage", "Silencieux", "Solaire",
          "Sous-Marin", "Soyeux", "Suave", "Sucre", "Sympa", "Thailandais", "Urbain", "Veloute", "Violet", "d'enigme",
          "d'ete", "d'Abaque", "d'Ambre", "d'Aqua", "d'Arome", "d'Arlequin", "d'Aura", "d'Automne", "d'Eau",
          "d'Harmonie", "d'Hiver", "d'Honneur", "d'Olive", "d'Or", "d'Orange", "de Bambou", "de Bord de la Mer",
          "de Bord du Lac", "de Bronze", "de Cabotage", "de Cacao", "de Cafe", "de Cannelle", "de Caramel", "de Caviar",
          "de Champagne", "de Chocolat", "de Coriandre", "de Couperet", "de Cramoisi", "de Cristal", "de Cuibre",
          "de Cuisson", "de Fantaisie", "de Feu", "de Front de Mer", "de Genevrier", "de Grande Ville", "de Jade",
          "de Jazz", "de Karma", "de Laiterie", "de Lavande", "de Lumiere", "de Malt", "de Miel", "de Paradis",
          ...
          "de Ville", "de Whisky", "de l'enigme", "de l'Ile", "de l'Est", "de l'Ouest", "de la Comete", "de la Cour",
          "de la Fable", "de la Flamme", "de la Foret", "de la Galerie", "de la Jungle", "de la Legende",
          "de la Montagne", "de la Nouille", "de la Plage", "de la Prairie", "de la Reine", "de la Riviere",
          "de la Rue", "de la Voie Navale", "des Caraibes", "du Canal", "du Coin", "du Curry", "du Feu", "du Fleuve",
          "du Nain", "du Nord", "du Pre", "du Quai", "du Roi", "du Sucre", "du Sud", "du Tribunal", "du Village",
          "Tropical", "Royal", "Principal", "Oriental", "Original", "Imperial", "Central", "Austral", "Amical"]
    r5 = ["elegante", "emeraude", "epicee", "Acide", "Acidulee", "Affamee", "Ambree", "Amere", "Ancienne", "Antique",
          "Arctique", "Ardente", "Argentee", "Bengale", "Bouillante", "Brulente", "Brillante", "Cotiere", "Carree",
          "Chaleureuse", "Charmante", "Chaude", "Chic", "Chouette", "Claire", "Cramoisie", "Doree", "Douce", "Fiere",
          "Folle", "FraIche", "Francaise", "Gracieuse", "Grecque", "Harmonique", "Incarnate", "Incroyable", "Indienne",
          "Italienne", "Japonaise", "Laitiere", "Lunaire", "Magique", "Marocaine", "Moderne", "Moelleuse", "Ovale",
          "Peinte", "Pimpante", "Polaire", "Privee", "Rare", "Relevee", "Rose", "Sacree", "Salee", "Sauvage",
          "Silencieuce", "Solaire", "Sous-Marine", "Soyeuse", "Suave", "Sucree", "Sympa", "Thailandaise", "Urbaine",
          "Veloutee", "Violette", "d'enigme", "d'ete", "d'Abaque", "d'Ambre", "d'Aqua", "d'Arome", "d'Arlequin",
          "d'Aura", "d'Automne", "d'Eau", "d'Harmonie", "d'Hiver", "d'Honneur", "d'Olive", "d'Or", "d'Orange",
          "de Bambou", "de Bord de la Mer", "de Bord du Lac", "de Bronze", "de Cabotage", "de Cacao", "de Cafe",
          ...
          "de Genevrier", "de Grande Ville", "de Jade", "de Jazz", "de Karma", "de Laiterie", "de Lavande",
          "de Lumiere", "de Malt", "de Miel", "de Paradis", "de Paume", "de Perle", "de Piments", "de Plage",
          "de Poivre", "de Printemps", "de Rubis", "de Safran", "de Saphir", "de Sarriette", "de Soie", "de Soufre",
          "de Sushi", "de Vanille", "de Verre", "de Village", "de Ville", "de Whisky", "de l'enigme", "de l'Ile",
          "de l'Est", "de l'Ouest", "de la Comete", "de la Cour", "de la Fable", "de la Flamme", "de la Foret",
          "de la Galerie", "de la Jungle", "de la Legende", "de la Montagne", "de la Nouille", "de la Plage",
          "de la Prairie", "de la Reine", "de la Riviere", "de la Rue", "de la Voie Navale", "des Caraibes", "du Canal",
          "du Coin", "du Curry", "du Feu", "du Fleuve", "du Nain", "du Nord", "du Pre", "du Quai", "du Roi", "du Sucre",
          "du Sud", "du Tribunal", "du Village", "Tropicale", "Royale", "Principale", "Orientale", "Originale",
          "Imperiale", "Centrale", "Australe", "Amicale"]
    r6 = ["l'echarpe", "l'epice", "l'etoile", "l'Ambiance", "l'Archive", "l'Atmosphere", "la Baie", "la Balade",
          "la Baleine", "la Basse", "la Biche", "la Brasserie", "la Cabane", "la Cantine", "la Capture", "la Chevre",
          "la Chambre", "la Cheminee", "la Cocotte", "la Cour", "la Couronne", "la Couverture", "la Crevette",
          "la Cuisine", "la Deesse", "la Duchesse", "l'Exposition", "la Facon", "la Fable", "la Fenetre", "la Ferme",
          "la Feuille", "la Fleur", "la Floraison", "la Fusion", "l'HuItre", "l'Idole", "l'Imperatrice", "la Legende",
          "la Lagune", "la Lanterne", "la Liaison", "la Libellule", "la Maison", "la Mare", "la Matinee",
          "la Merveille", "la Mission", "la Morsure", "la Nappe", "la Nuit", "l'Orchidee", "la Paloudre", "la Parole",
          "la Perle", "la Pizzeria", "la Pomme", "la Porte", "la Poule", "la Promenade", "la Recolte", "la Rose",
          "la Route", "la Ruche", "la Rue", "la Salle", "la Saveur", "la Soiree", "la Source", "la Table", "la Tour",
          "la Tulipe", "l'Usine", "la Vache", "la Vallee", "la Victoire", "la Vigne", "la Voute", "la Voie", "la Vue",
          "l'echange", "l'elephant", "l'erable", "l'etalage", "l'Ange", "l'Apres-Midi", "l'Arbre", "le Balcon",
          "le Bassin", "le Bateau", "le Bijou", "le Bistro", "le Blaireau", "le Bloc", "le Bosquet", "le Boulevard",
          "le Coeur", "le Carrefour", "le Cavalier", "le Cerf", "le Chateau", "le Chene", "le Champ", "le Chef",
          "le Chemin", "le Cheval", "le Chevalier", "le Ciel", "le Club", "le Coin", "le Colibri", "le Commandant",
          "le Cottage", "le Demon", "le DIner", "le DIneur", "le Dome", "le Diable", "le Dieu", "le Dragon", "le Duc",
          "l'Empereur", "l'Endroit", "le Fleur", "le Forgeron", "le Foulard", "le Foyer", "le Frigo", "le Genie",
          "le Gout", "le Gril", "le Hall", "le Homard", "l'Instant", "le Jardin", "le Lien", "le Lieu", "le Lion",
          "le Lis", "le Loup", "le Melange", "le Manoir", "le Marche", "le Matin", "le Miroir", "le Moisson",
          "le Moment", "le Monument", "le Morceau", "le Mot", "le Moulin", "le Navire", "le Nuage", "l'Ours",
          "le Petale", "le Palais", "le Panda", "le Paradis", "le Parc", "le Parfum", "le Parloir", "le Paysan",
          "le Perchoir", "le Phare", "le Piment", "le Poisson", "le Port", "le Quai", "le Reve", "le Ranch",
          "le Renard", "le Requin", "le Salon", "le Sanglier", "le Saule", "le Saumon", "le Singe", "le Sommet",
          "le Tableau", "le Tambour", "le Theatre", "le Tigre", "le Toit", "le Trefle", "le Triomphe", "le Vaisseau",
          "le Verger", "le Violon", "le Violoneux", "le Yard"]
    r7 = ["elementaire", "Acapella", "Agrume", "Alpha", "Ambiance", "Aqua", "Atlas", "Babylone", "Bambino", "Basilic",
          "Boutons", "Cacao", "Citronnelle", "Clair de Lune", "Clarte", "Coquin", "Coucher du Soleil", "Curiosite",
          "Eau", "Eureka", "Feu et Glace", "Fleurs", "Floraisons", "Fluorescence", "Geant", "Gentil", "Grace",
          "Harmonie", "Incognito", "Indigo", "Legendaire", "Lavande", "Lueuer des etoiles", "Maximus", "Merveille",
          "Minuit", "Miroirs", "Modestie", "Nirvana", "Nova", "Oiseau de Nuit", "Petales", "Petite Chine",
          "Petite Italie", "Petite Perse", "Piccolo", "Primordial", "Purete", "Recreation", "Retro", "Revelations",
          "Reveries", "Reines", "Royal", "Seduction", "Serenite", "Safran", "Seigle", "Shazam", "Solitude",
          "Tranquillite", "Vagabonds", "Vers le Ciel", "Violoneux", "des Os", "l'eclipse", "l'enigme", "l'erable",
          "l'etalage", "l'evenement", "l'Ile", "l'Abaque", "l'Accord", "l'Ace", "l'Agneau", "l'Amusement", "l'Arome",
          "l'Arche", "l'Arlequin", "l'Atmosphere", "l'Aura", "l'Aurore", "l'Empereur", "l'Entracte", "l'Exposition",
          "l'Hibiscus", "l'Imperatrice", "l'Interlude", "l'Intermezzo", "l'Intermission", "l'Interruption", "l'Ivoire",
          ...
          "la Chevre", "la Chance", "la Chandelle", "la Cime", "la Couronne", "la Curiosite", "la Fable",
          "la Fantaisie", "la Fusion", "la Galerie", "la Gemme", "la Goutte", "la Grotte", "la Joliesse", "la Legende",
          "la Lagune", "la Liaison", "la Lumiere des etoiles", "la Muraille", "la Niche", "la Nuit", "la Nuit Tombee",
          "la Penombre", "la Pagaille", "la Pause", "la Perle", "la Perspective", "la Petite Maison", "la Prairie",
          "la Prime", "la Recolte", "la Reverie", "la Rose", "la Ruche", "la Serenade", "la Salutation", "la Sensation",
          "la Serre", "la Singularite", "la Tour", "la Tribune", "la Trilogie", "la Trinite", "la Tulipe",
          "la Verrerie", "la Vieillesse", "la Vigne", "la Voute", "la Vue", "le Bosquet", "le Calcaire", "le Calme",
          "le Carnaval", "le Chateau", "le Chapeau", "le Chapitre", "le Charme", "le Clocher", "le Colibri",
          "le Cottage", "le Couloir", "le Crane", "le Crepuscule", "le Creuset", "le Depot", "le Forestier",
          "le GastroGnome", "le Gastronome", "le Grillage", "le Jardin", "le Jubile", "le Karma", "le Labyrinthe",
          "le Lien", "le Lierre", "le Lion", "le Lis", "le Lotus", "le Medaillon", "le Marmonnement", "le Mirage",
          "le Monarque", "le Monument", "le Mur", "le Nomade", "le Paon", "le Parangon", "le Parloir", "le Pavillon",
          "le Plan", "le Podium", "le Pre", "le Projet", "le Roti", "le Recoin", "le Relais", "le Robot",
          "le Rossignol", "le Sanglier", "le Saphir", "le Saule", "le Solstice", "le Sommet", "le Sortilege",
          "le Soufre", "le Sourire", "le Sous-Sol", "le Tresor", "le Turban", "le Vignoble", "le Voile", "les ames",
          "les elements", "les Amis", "les Bandits", "les Grillons", "les Prairies", "les Rois"]
...
class Jeweller(object):
    j1 = ['A Hill of Beads', 'A Sparkly Thing', 'A Strand Above', 'A Strand For You', 'Accustomed', 'Adornmix',
          ...
          'Discoveries', 'Doodads', 'Earth Unique Jewelry', 'Ecletic Creations', 'Elements: Wearable Art',
...
class Brothel(object):
    s = ['Daisies', 'The Don', 'Blinkers', 'The Prudes Suspenders', 'Gold\'s Dust', 'The Velvet Fang',
         'The Whisper Home', 'The Hook', 'Over the River', 'Slooshes', 'The Rapid Rascal', 'The Stoat',
         'The Fidgety Ferret', 'Long Shaft', 'The Guards', 'Chastity\'s', 'The Mask', 'The Red Dress', 'Jewels',
         'Silken Flute', 'The Nag\'s Head', 'Drummers', 'Sailors Choice', 'Blacksmiths Envy', 'The Nagging Wife',
         'Colins Rubble', 'Drons Beat', 'The Wink', 'Maggie\'s Horn', 'The Sun & Cider', 'The Oakworm',
         'Tickle & Feather', 'The Mistress', 'Madam Zersannies', 'The Kings Court', 'The Cursed Coin', 'Slit',
         'The Maiden Head', 'The Silken Ferret', 'Long Legs', 'Elven Whispers', 'The Leg',
         'False Suspenders', 'Aunt Fannies Bloomers', 'Final Rest', 'Cocks Crow', 'The Unblinking Eye',
         'The Bountiful Bosom', 'Tuskers', 'The Thrusting Gentleman', 'Tally Hoes', 'Rutting', 'Pigs in Blankets',
         'The Delicate Touch', 'Aphrodite\'s Wish', 'The Dirty Secret', 'Long Locks', 'Sweat', 'Brothel', 'Taters',
         'The Swift Finish', 'Cumberlands', 'The Missing Sausage', 'The Fools Frolic', 'Dragons', 'The Bushel',
         'Farmers Oats', 'The Raised Brow', 'Genies', 'The Farfetched Feather', 'Junk', 'The Connoisseur\'s Choice',
         'Colossus', 'The Smooth Ride', 'Bucking', 'The Great Big Globes', 'The Glimmeric', 'Loving Embrace',
         'Chokers Necklace', 'The Grand Madams Emporium of Fine Delicacies, Treats, and the Exotic', 'Thug\'s Retreat',
         'Warriors Return', 'Gold Gobblers', 'Cackling Croons', 'The Warty', 'Bessie\'s Best', 'Corset', 'Winkies',
         'The Shagger', 'Port of Call', 'The Home away from Hoes', 'Smooth', 'The Maiden Fair', 'The Bit', 'Hosted',
         'Glamourous Delights', 'Happily Ever After', 'Sultry Stare', 'The Full Flush', 'The Dark Cavern',
         'The Deep Thoroughfare', 'The Hidden Depths', 'The Massive Oak', 'The Tall Mast', 'The Quivering Hills',
         'The Steamy Engine', 'The Lair of the Two-Backed Beast', 'The Row of Rigid Spears', 'Sultry Scullion',
         'The Rusty Pipe', 'Ye Old Festhall', 'Shambling Mounds', 'The Out Inn', 'The Shagging Carpet', 'The Plot Hole',
         'The Pink Hydra', 'The Gelatinous Cube', 'The Locked Gauntlet', 'Ten Foot Ladder', 'The Come and Go',
         'The Clockwork Dollhouse', 'The Wild Wild West', 'The Very Jolly Roger', 'This is Not a Brothel',
         'The Salty Clam', 'Classy Lassies', 'Tally Hoes', 'Breast Buy', 'Pussy Galore', 'The Lancer\'s Tilt',
         'The Piston', 'The Wandering Eye', 'The Sure Thing', 'What Awaits', 'Nothing and More', 'The Minotaurs Horn',
         'The Witches Wiggle', 'The Fighting Buck', 'The Noble Nymph', 'The Portly Sorcerer', 'The Shag Pile',
         'The Spoony Bardesses', 'The Greasy Wheel', 'Pretty & Witty & Gay', 'The Purple Party Pantaloons',
         'The Ascended Kobold', 'Pick - a - Dilly Square', 'The Paladin\'s Mount', 'The Kitty and the Rooster',
         'The Pearl', 'Iron Heart Surge', 'We Sell Scrolls of Remove Disease', 'The Masterwork Stirrup',
         'The Ten Foot Pole', 'The Prancing Pink Party Pony', 'A Whore of a Different Color',
         'The Halfling\'s Quarterstaff', 'Crank Shaft Grinders', 'The Rusty Scabbard', 'The Lady Hole',
         'The Pink Lagoon', 'The Clam Shack', 'The Piping Pie Inn', 'Sadie\'s Sweet Meats', 'The Breach',
         'The Easy Cleaver', 'The Easy Beaver', 'The Eager Beaver', 'The Wet Seal', 'The Gap', 'Maiden\'s Kiss',
         'The Cumly Maden', 'The Milk Depository', 'The Butter Factory', 'The Milking Station', 'The Milk Maid\'s Inn',
         'The Ruddy Knees Inn', 'The Sqeaky Wheel', 'The Bicycle Club', 'The Riding Club', 'The Jockey\'s Club ',
         'The Glass Blower', 'The Beer Goggles', 'Balloon Ride', 'The Tank and Spank', 'Bigby\'s Enjoyable Hand',
         'Mordenkainen\'s Luxurious Loveshack', 'Otiluke\'s Spheres', 'Flurry of Blows', 'Butterchurn', 'Happy Eel',
         'Rose Garden', 'The Changeling\'s Secret',  'The Portable Hole', 'Century Worm', 'Rod of Lordly Might',
         'Robe of Bones', 'The Bread Gazebo', 'Just an Ordinary Storefront', 'Aunty\'s Helping Hands',
         'The Bearded Clam', 'The Smurven Hammer', 'The Ramrod.', 'The Truss \'n Stuff', 'The Rowdy Beaver',
         'The Love Bite', 'The Love Tap', 'The Hate Hit',  'The Sucking Succubus', 'House of Heavenly Delights',
         'Guild For The Oldest Job', 'Lady Marmalade\'s House', 'Cunning Linguists Guild', 'The Rocking Horses',
         'House of Hung Harrys', 'Rod of Wonder', 'Lords of Rodly Might', 'Gloryhouse', 'The Healing Surge',
         'The Sunken Pole', 'The Mosquito\'s Rest', 'The Spring and Flange Assembly',  'Afternoon\'s Delight',
         'The Blue Oyster', 'The Gaudy Bawdy', 'The Pickled Pecker', 'The Loose Rudder', 'The Rusty Rollocks',
         'The Wandering Tiller', 'The Able Seamen', 'Steppin the Mast', 'The Wayward Bouy', 'The Fish Net Inn',
         'The Glorious Booty', 'The Precious Booty', 'The Salty Transmission', 'Den of Iniquity', 'Massage Parlor',
         'The Red Door', 'The Growing Cock', 'The Swallowing Maiden', 'Gobbling Girties', ]
...
class Gunsmithing(object):
    s1 = ["Abomination", "Agony", "Allegiance", "Alpha", "Amigo", "Amnesia", "Apocalypse", "Armageddon", "Ash", "Ashes",
          "Atomic Annie", "Baby", "Battery", "Battlestar", "Betrayal", "Betrayer", "Big Bertha", "Mighty Mouse",
          "Betty", "Quick Fix", "Swiftscope", "Bad Medicine", "Toots", "Enterprise", "Big Rhonda", "Crowd Control",
          "Intervention", "Matilda", "Pink Mist", "Judas", "Headhunter", "Jaeger", "Lupus", "Big Daddy", "Big Game",
          "Birthmark", "Blackout", "Bloodfury", "Bloodmoon", "Bloodrage", "Bloodspiller", "Bloodweep", "Bombardment",
          "Boomer", "Boomstick", "Brass Rain", "Brutality", "Brutalizer", "Bulldog", "Burn", "Burp", "Cataclysm",
          "Catastrophe", "Chance", "Chaos", "Comet", "Corpsemaker", "Corruption", "Cosmos", "Crash", "Crimson",
          "Crossfire", "Cruiser", "Crush", "Cyclone", "Daddy", "Damnation", "Darkness", "Dawn", "Deadeye",
          "Deathbringer", "Deathraze", "Decimation", "Demise", "Desolation", "Despair", "Destiny", "Destruction",
          "Devastation", "Devotion", "Devourer", "Discharge", "Disturbance", "Divine", "Dominance", "Dominion", "Doom",
          "Downpour", "Dragonmaw", "Dragonstrike", "Dreamhunter", "Due Diligence", "Early Retirement", "Echo",
          "Eclipse", "Emergency", "End of Dreams", "Endbringer", "Enigma", "Envy", "Epilogue", "Equality", "Equalizer",
          "Eternal Rest", "Eternity", "Eveningstar", "Extermination", "Extinction", "Falcon", "Falling Star", "Fate",
          "Finality", "Frankenlove", "Frankenstein", "Frenzy", "Fury", "Gov'ner", "Grace", "Harbinger", "Harmony",
          "Hatred", "Heat", "Hell's Scream", "Homage", "Honor's Call", "Hope's End", "Infamy", "Infinity", "Injection",
          "Interrogator", "Judged", "Justice", "Justifier", "King of Nines", "Knight's Fall", "Knightfall", "Lament",
          "Last Chance", "Last Laugh", "Last Rites", "Last Word", "Last Words", "Lazarus", "Legacy", "Legionaire",
          "Life's Limit", "Lightning", "Lightningflash", "Limbo", "Lockjaw", "Magma", "Malice", "Maneater", "Massacre",
          "Mercy", "Midnight", "Misery's End", "Moonsight", "Mortality", "Narcoleptic", "Night's Fall", "Nightbane",
          "Nightfall", "Nightmare", "Nighttime", "Nightwatch", "Nirvana", "Oathbreaker", "Oathkeeper", "Oblivion",
          "Ole Betsy", "Omega", "Optimist", "Orbit", "Party Pooper", "Patience", "Peacekeeper", "Peacemaker",
          "Pendulum", "Perfect Storm", "Persuasion", "Piety", "Popeye", "Pride", "Prophecy", "Pulse", "Punisher",
          "Purifier", "Rage", "Rapture", "Rattlesnake", "Reckoning", "Reign", "Remorse", "Requiem", "Retirement",
          "Rigormortis", "Salvation", "Salvo", "Scar", "Serenity", "Severance", "Shadowfury", "Shadowmoon", "Silence",
          "Snake", "Snapper", "Soulburn", "Sprocket", "Stalker", "Storm", "Storm Breaker", "Storm-Weaver",
          "Stormbringer", "Stormrider", "Sugar", "Sunshine", "Supernova", "Supremacy", "Suspension", "Swan Song",
          "Sweetie", "Syndrome", "Termination", "The Ambassador", "The Chancellor", "The End", "The Judge", "The Light",
          "The Oculus", "The Oracle", "The Pig", "The Void", "Thunder", "Thundercall", "Trauma", "Treachery", "Tremor",
          "Tribunal", "Tribute", "Trinity", "Trouble", "Twilight", "Typhoon", "Ubiquity", "Undoing", "Vacancy",
          "Valkyrie", "Vanquisher", "Vengeance", "Voice of Insanity", "Voice of Reason", "Warbringer", "Warmonger",
          "Whispers", "Whisperwind", "Wicked", "Widow Maker", "Willbreaker", "Wit's End", "Wolf"]
    s2 = ["Apocalypse", "Apocalyptic", "Atuned", "Bandit's", "Baneful", "Banished", "Barbaric", "Battleworn",
          "Blood Infused", "Blood-Forged", "Bloodied", "Bloodlord's", "Bloodsurge", "Brutal", "Brutality", "Burnished",
          "Cataclysm", "Cataclysmic", "Challenger", "Challenger's", "Champion", "Cold-Forged", "Commando", "Commando's",
          "Conqueror", "Conqueror's", "Corroded", "Corrupted", "Crazed", "Dancing", "Dark", "Darkness", "Defender",
          "Defender's", "Defiled", "Defiling", "Deluded", "Deserted", "Desire's", "Desolation", "Destiny's",
          "Diabolical", "Dire", "Doom", "Doom's", "Eerie", "Engraved", "Eternal", "Exiled", "Extinction", "Faith's",
          "Faithful", "Fancy", "Fearful", "Feral", "Ferocious", "Fierce", "Fireguard", "Firestorm", "Forsaken",
          "Fortune's", "Foul", "Frenzied", "Furious", "Fusion", "Ghastly", "Ghostly", "Gladiator", "Gleaming",
          "Glinting", "Greedy", "Grieving", "Grim", "Guard's", "Guardian's", "Guerilla", "Hateful", "Heartless",
          "Heinous", "Hero", "Hero's", "Honed", "Honor's", "Hopeless", "Howling", "Hungering", "Incarnated", "Infantry",
          "Infantry's", "Infused", "Inherited", "Judgement", "Keeper's", "Legionnaire's", "Liar's", "Lightning",
          "Lonely", "Loyal", "Lustful", "Lusting", "Malevolent", "Malicious", "Malificent", "Malignant", "Massive",
          "Mended", "Mercenary", "Military", "Misfortune's", "Mourning", "Nightmare", "Oathkeeper's", "Ominous",
          "Peacekeeper", "Peacekeeper's", "Phantom", "Polished", "Pride's", "Prideful", "Primal", "Prime", "Primitive",
          "Private", "Promised", "Protector's", "Proud", "Pure", "Raging", "Recruit's", "Refined", "Reforged",
          "Reincarnated", "Relentless", "Remorseful", "Renewed", "Renovated", "Replica", "Restored", "Retribution",
          "Ritual", "Roaring", "Savage", "Sentinel", "Shadow", "Silent", "Singed", "Singing", "Sinister", "Smooth",
          "Soldier's", "Solitude's", "Sorrow's", "Soulless", "Spectral", "Spiteful", "Storm", "Storm-Forged",
          "Stormfury", "Stormguard", "Terror", "Thirsting", "Thirsty", "Thunder", "Thunder-Forged", "Thunderfury",
          "Thunderguard", "Thundersoul", "Thunderstorm", "Timeworn", "Trainee's", "Treachery's", "Trooper", "Twilight",
          "Twilight's", "Twisted", "Tyrannical", "Vanquisher", "Vengeance", "Vengeful", "Veteran", "Veteran's",
          "Vicious", "Victor", "Vile", "Vindication", "Vindicator", "Vindictive", "Void", "Vowed", "War", "War-Forged",
          "Warden's", "Warlord's", "Warmonger", "Warmonger's", "Warp", "Warped", "Warrior", "Warrior's", "Whistling",
          "Wicked", "Windsong", "Woeful", "Wrathful", "Wretched", "Yearning", "Zealous"]
    s3 = ["Bronze", "Bronzed", "Ivory", "Ebon", "Glass", "Golden", "Gilded", "Chromed", "Iron", "Stainless", "Carbon",
          "Brass", "Fiberglass", "Ironbark", "Mithril", "Obsidian", "Silver", "Steel", "Titanium"]
    s4 = ["Rifle", "Carbine", "Blaster", "Fusil", "Launcher", "Shooter", "Repeater", "Sniper", "Longrifle"]
    s5 = ["Agent", "Allegiance", "Ambassador", "Annihilation", "Bearer", "Betrayer", "Blaster", "Bond", "Boomstick",
          "Boon", "Breaker", "Bringer", "Bruiser", "Butcher", "Call", "Carbine", "Carrier", "Champion", "Conqueror",
          "Courier", "Crier", "Crusader", "Crusher", "Cry", "Cunning", "Dawn", "Defender", "Defiler", "Delegate",
          "Destroyer", "Dispatcher", "Disposer", "Emissary", "Ender", "Envoy", "Executioner", "Favor", "Ferocity",
          "Foe", "Fusil", "Gift", "Glory", "Guardian", "Harbinger", "Heirloom", "Herald", "Hope", "Incarnation",
          "Last Hope", "Last Stand", "Launcher", "Legacy", "Longrifle", "Memory", "Messenger", "Might", "Musket",
          "Oath", "Pact", "Pledge", "Pounder", "Promise", "Prophecy", "Protector", "Queller", "Ravager", "Reach",
          "Reaper", "Repeater", "Rifle", "Scepter", "Sculptor", "Secret", "Shooter", "Shotgun", "Slayer", "Smasher",
          "Sniper", "Soul", "Suppressor", "Terror", "Token", "Tribute", "Vengeance", "Voice", "Whisper", "Wit"]
    s6 = ["of Agony", "of Ancient Power", "of Anguish", "of Ashes", "of Assassins", "of Black Magic",
          "of Blessed Fortune", "of Blessings", "of Blight", "of Blood", "of Bloodlust", "of Broken Bones",
          ...
          "of Heroes", "of Holy Might", "of Honor", "of Hope", "of Horrid Dreams", "of Horrors",
          "of Illuminated Dreams", "of Illumination", "of Immortality", "of Inception", "of Infinite Trials",
          "of Insanity", "of Invocation", "of Justice", "of Light's Hope", "of Lost Comrades", "of Lost Hope",
          "of Lost Voices", "of Lost Worlds", "of Magic", "of Mercy", "of Misery", "of Mountains", "of Mourning",
          "of Mystery", "of Necromancy", "of Nightmares", "of Oblivion", "of Perdition", "of Phantoms", "of Power",
          "of Pride", "of Pride's Fall", "of Putrefaction", "of Reckoning", "of Redemption", "of Regret", "of Riddles",
          "of Secrecy", "of Secrets", "of Shadow Strikes", "of Shadows", "of Shifting Sands", "of Shifting Worlds",
          "of Silence", "of Slaughter", "of Souls", "of Stealth", "of Storms", "of Subtlety", "of Suffering",
          "of Suffering's End", "of Summoning", "of Terror", "of Thunder", "of Time-Lost Memories",
          "of Timeless Battles", "of Titans", "of Torment", "of Traitors", "of Trembling Hands", "of Trials",
          "of Truth", "of Twilight's End", "of Twisted Visions", "of Unholy Blight", "of Unholy Might", "of Vengeance",
          "of Visions", "of Wasted Time", "of Widows", "of Wizardry", "of Woe", "of Wraiths", "of Zeal",
          "of the Ancients", "of the Banished", "of the Basilisk", "of the Beast", "of the Blessed",
          "of the Breaking Storm", "of the Brotherhood", "of the Burning Sun", "of the Caged Mind", "of the Cataclysm",
          "of the Champion", "of the Claw", "of the Corrupted", "of the Covenant", "of the Crown", "of the Damned",
          "of the Daywalker", "of the Dead", "of the Depth", "of the Dreadlord", "of the Earth", "of the East",
          "of the Emperor", "of the Empty Void", "of the End", "of the Enigma", "of the Fallen", "of the Falling Sky",
          "of the Flame", "of the Forest", "of the Forgotten", "of the Forsaken", "of the Gladiator", "of the Harvest",
          "of the Immortal", "of the Incoming Storm", "of the Insane", "of the King", "of the Lasting Night",
          "of the Leviathan", "of the Light", "of the Lion", "of the Lionheart", "of the Lone Victor",
          "of the Lone Wolf", "of the Lost", "of the Moon", "of the Moonwalker", "of the Night", "of the Night Sky",
          "of the Nightstalker", "of the North", "of the Occult", "of the Oracle", "of the Phoenix", "of the Plague",
          "of the Prince", "of the Protector", "of the Queen", "of the Serpent", "of the Setting Sun", "of the Shadows",
          "of the Sky", "of the South", "of the Stars", "of the Storm", "of the Summoner", "of the Sun",
          "of the Sunwalker", "of the Talon", "of the Undying", "of the Victor", "of the Void", "of the West",
          "of the Whispers", "of the Wicked", "of the Wind", "of the Wolf", "of the World", "of the Wretched"]
    s7 = ["Abomination", "Agony", "Allegiance", "Alpha", "Amigo", "Amnesia", "Apocalypse", "Armageddon", "Ash", "Ashes",
          "Atomic Annie", "Baby", "Battery", "Battlestar", "Betrayal", "Betrayer", "Big Bertha", "Mighty Mouse",
          "Betty", "Quick Fix", "Swiftscope", "Bad Medicine", "Toots", "Enterprise", "Big Rhonda", "Crowd Control",
          "Intervention", "Matilda", "Pink Mist", "Judas", "Headhunter", "Jaeger", "Lupus", "Big Daddy", "Big Game",
          "Birthmark", "Blackout", "Bloodfury", "Bloodmoon", "Bloodrage", "Bloodspiller", "Bloodweep", "Bombardment",
...
class Guilds:
    ...
    nm1 = ["Acts", "Affliction", "Agony", "Allies", "Ambition", "Angels", "Anger", "Anguish", "Anomalies", "Archers",
           "Army", "Assassins", "Association", "Atonement", "Attack", "Avengers", "Avenging", "Ban", "Bandits", "Bane",
           "Beasts", "Betrayal", "Birth", "Blaze", "Blessing", "Blood", "Bond", "Boon", "Bounty", "Brigade", "Burden",
           "Butchers", "Champions", "Children", "Citizens", "Civilians", "Commandos", "Companions", "Conquerors",
           "Contract", "Corruption", "Courage", "Crew", "Crushers", "Cry", "Curse", "Damnation", "Dawn", "Deceivers",
           "Demons", "Desire", "Destiny", "Disciples", "Disruption", "Disturbance", "Division", "Dream", "Dreamers",
           "Duty", "End", "Enemies", "Enigmas", "Entities", "Evolution", "Executioners", "Faith", "Fame", "Favor",
           "Fiends", "Fight", "Fighters", "Flames", "Flash", "Flight", "Force", "Forgiveness", "Fortune", "Freaks",
           "Frenzy", "Gang", "Genocide", "Ghosts", "Gift", "Gladiators", "Glory", "Grace", "Grief", "Grudge",
           "Guardians", "Guards", "Hammers", "Harbingers", "Harmony", "Harvesters", "Hate", "Hell", "Heralds", "Heroes",
           "Home", "Honor", "Hope", "Horde", "Host", "House", "Howl", "Hunters", "Illusions", "Immortals", "Justice",
           "Keepers", "Killers", "Knights", "Last", "Legacy", "Legion", "Light", "Mages", "Masters", "Memories", "Men",
           "Mercenaries", "Messengers", "Might", "Minds", "Misery", "Monsters", "Mysteries", "Mystery", "Mystics",
           "Myth", "Nightmares", "Oath", "Oracles", "Order", "Outcasts", "Outlaws", "Outsiders", "Overseers", "Pact",
           "Pain", "Paladins", "Passion", "Patience", "Peace", "Phantoms", "Plague", "Promise", "Prophecies",
           "Prophets", "Protection", "Protectors", "Punishment", "Purification", "Pursuit", "Quiet", "Rage", "Raiders",
           "Rangers", "Rebellion", "Rebels", "Rebirth", "Recovery", "Recruits", "Redemption", "Refugees", "Rejects",
           "Relics", "Requiem", "Residents", "Retaliation", "Retribution", "Revelations", "Revenge", "Riddles",
           "Riders", "Rise", "Rivals", "Roar", "Rogues", "Ruins", "Rumours", "Sacrifice", "Safety", "Scourge", "Scouts",
           "Screams", "Screech", "Secret", "Secrets", "Seducers", "Seekers", "Seers", "Sentinels", "Serenity",
           "Service", "Shades", "Shadows", "Shamans", "Shame", "Shepherds", "Shields", "Silence", "Sinners", "Smiles",
           "Society", "Soldiers", "Sorcerers", "Spears", "Specters", "Spirits", "Spite", "Squad", "Stalkers",
           "Stewards", "Storm", "Strangers", "Strength", "Struggle", "Survivors", "Swarm", "Swords", "Tears", "Tempest",
           "Templars", "Terror", "Thieves", "Thugs", "Thunder", "Tirade", "Torment", "Tradition", "Traitors",
           "Tranquillity", "Treasure", "Trial", "Trust", "Vendetta", "Vengeance", "Venom", "Victims", "Vigor",
           "Vikings", "Villains", "Vision", "Visions", "Visitors", "Voice", "Voices", "Wards", "Warlords", "Warriors",
           "Wealth", "Weapons", "Weight", "Whisper", "Whispers", "Widows", "Witches", "Wizards", "Women", "Workers",
           "Wound", "Wraiths", "Wrath", "Yell"]
    nm2 = ["from the Empire", "from the Forest", "from the Grave", "from the Mountains", "from the Ocean",
           "from the People", "from the Sea", "from the Woods", "of Abandonment", "of Ambition", "of Angels",
           "of Anger", "of Betrayal", "of Claws", "of Corruption", "of Courage", "of Damnation", "of Darkness",
           "of Death", "of Decay", "of Deception", "of Defiance", "of Delusion", "of Desire", "of Devotion",
           "of Disease", "of Ending", "of Extinction", "of Faith", "of Fear", "of Forests", "of Fortune", "of Fury",
           "of Hate", "of Heroes", "of Honor", "of Hope", "of Impurity", "of Innocence", "of Joy", "of Life",
           "of Light", "of Loyalty", "of Might", "of Mountains", "of Mystery", "of Mystics", "of Nature", "of Oceans",
           "of Patience", "of Promises", "of Purity", "of Rejects", "of Seduction", "of Serenity", "of Shadows",
           "of Shame", "of Skulls", "of Strength", "of Tricks", "of Trust", "of Vigor", "of Virtue", "of Wolves",
           "of the Abandoned", "of the Alligator", "of the Ambitious", "of the Angelic", "of the Angry", "of the Ape",
           "of the Badger", "of the Bear", "of the Betrayed", "of the Bitter", "of the Boar", "of the Bold",
           "of the Bound", "of the Brave", "of the Buffalo", "of the Bull", "of the Carious", "of the Cheeky",
           "of the Classified", "of the Claw", "of the Clean", "of the Cobra", "of the Collapsed", "of the Concealed",
           "of the Corrupt", "of the Corrupted", "of the Cosmos", "of the Cougar", "of the Covert", "of the Crocodile",
           "of the Crooked", "of the Crow", "of the Crumbled", "of the Damned", "of the Dark", "of the Dead",
           "of the Decayed", "of the Deceased", "of the Deceived", "of the Defiant", "of the Deluded", "of the Demonic",
           "of the Departed", "of the Depraved", "of the Deserted", "of the Desired", "of the Despicable",
           "of the Devoted", "of the Discarded", "of the Diseased", "of the Disgraceful", "of the Dishonest",
           "of the Dissipated", "of the Dog", "of the Dove", "of the Dragon", "of the Dragonfly", "of the Eager",
           "of the Eagle", "of the Earth", "of the Ended", "of the Enraged", "of the Extinct", "of the Faithful",
           "of the Fallen", "of the Fearless", "of the Feeble", "of the Fierce", "of the Forbidden", "of the Forest",
           "of the Forgotten", "of the Forsaken", "of the Fortunate", "of the Fox", "of the Furious", "of the Galaxy",
           "of the Gorilla", "of the Grave", "of the Ground", "of the Hallowed", "of the Hateful", "of the Hawk",
           "of the Heroic", "of the Hidden", "of the Holy", "of the Honest", "of the Honored", "of the Hopeful",
           "of the Horse", "of the Humble", "of the Ill", "of the Immoral", "of the Impure", "of the Infernal",
           "of the Innocent", "of the Jackal", "of the Jaguar", "of the Joyful", "of the Joyous", "of the Jungle",
           "of the Lake", "of the Lamb", "of the Land", "of the Last Age", "of the Lewd", "of the Light", "of the Lion",
           "of the Living", "of the Lost", "of the Lost Age", "of the Loyal", "of the Lynx", "of the Mace",
           "of the Meek", "of the Mental", "of the Mighty", "of the Mislead", "of the Moon", "of the Mountain",
           "of the Mysterious", "of the Mystical", "of the Natural", "of the Nefarious", "of the Night", "of the Noble",
           "of the Obscene", "of the Obscure", "of the Ocean", "of the Owl", "of the Passive", "of the Patient",
           "of the Perished", "of the Pious", "of the Poor", "of the Pristine", "of the Profane", "of the Promised",
           "of the Pure", "of the Putrid", "of the Ram", "of the Rat", "of the Raven", "of the Reckless",
           "of the Rejected", "of the Resolute", "of the Revenant", "of the Rhino", "of the Rich", "of the Right",
           "of the Righteous", "of the Rotten", "of the Ruined", "of the Sacred", "of the Sacrificed",
           "of the Scorpion", "of the Sea", "of the Seduced", "of the Serene", "of the Serpent", "of the Shadows",
           "of the Shameless", "of the Shark", "of the Sheep", "of the Shield", "of the Sick", "of the Sincere",
           "of the Skull", "of the Snake", "of the Sophisticated", "of the Spear", "of the Spider", "of the Stag",
           "of the Stars", "of the Stout", "of the Strong", "of the Sun", "of the Sword", "of the Taboo",
           "of the Tainted", "of the Talon", "of the Tame", "of the Tiger", "of the Tricked", "of the Trusted",
           "of the Undead", "of the Universe", "of the Unknown", "of the Valiant", "of the Vanquished",
           "of the Vicious", "of the Vigorous", "of the Virtuous", "of the Void", "of the Vulture", "of the Wasted",
           "of the Weak", "of the Weasel", "of the Wicked", "of the Withered", "of the Wolf", "of the Wolves",
           "of the Woods", "of the World", "of the Wretched", "of the Wrong"]
    nm3 = ["Aqua", "Arm", "Banner", "Battle", "Bellow", "Black", "Blood", "Blue", "Bone", "Boulder", "Bright", "Bronze",
           "Burning", "Chaos", "Char", "Cold", "Cunning", "Dark", "Dashing", "Doom", "Drum", "Earth", "Ebon", "Fallen",
           "Fel", "Fire", "Forge", "Forsaken", "Frost", "Gentle", "Golden", "Gray", "Hallow", "Hell", "High", "Hollow",
           "Howling", "Humming", "Iron", "Ivory", "Jade", "Killing", "Lightning", "Low", "Mad", "Magic", "Marble",
           "Metal", "Midnight", "Monster", "Moon", "Night", "Poison", "Quick", "Rain", "Raven", "Red", "Rumble",
           "Running", "Shadow", "Shatter", "Shimmer", "Shiver", "Silver", "Snow", "Solar", "Split", "Steel", "Stone",
           "Storm", "Sun", "Swift", "Thunder", "Tremble", "Twin", "Venom", "Water", "White", "Wind", "Wrecking"]
    nm4 = [" Assault", " Dragons", " Eagles", " Foxes", " Hawks", " Hearts", " Lust", " Maggots", " Oath", " Rage",
           " Rats", " Wolves", "arrows", "bane", "beards", "blades", "bow", "brand", "brawlers", "breaker", "brows",
           "cloaks", "clouds", "crawlers", "crushers", "cry", "dawn", "death", "fall", "field", "fists", "flags",
           "flayers", "force", "ford", "forge", "fury", "garde", "glades", "guard", "guards", "hammers", "hands",
           "hoods", "landers", "laws", "light", "manes", "mantles", "might", "pikes", "roses", "scars", "shade",
           "shapers", "shields", "shifters", "shroud", "sins", "skulls", "smiths", "song", "stars", "stand", "striders",
           "swords", "talons", "thorn", "tops", "tips", "vale", "well"]
    nm5 = ["Abandoned", "Accurate", "Alchemy", "Alpha", "Ambitious", "Amused", "Angelic", "Angry", "Arcane", "Aspiring",
           "Assassins", "Assorted", "Awful", "Banished", "Betrayed", "Bite-sized", "Bitter", "Black", "Blades", "Blue",
           "Bold", "Bound", "Bounty", "Brave", "Broken", "Burning", "Chosen", "Clean", "Closed", "Collapsed", "Common",
           "Concealed", "Contract", "Corrupt", "Corrupted", "Crescent", "Crimson", "Crumbled", "Cutlass", "Damned",
           "Dark", "Dazzling", "Decayed", "Deceased", "Deceived", "Defiant", "Delicate", "Deluded", "Demolition",
           "Demonic", "Departed", "Depraved", "Deserted", "Desired", "Despicable", "Devoted", "Discarded", "Diseased",
           "Disgraceful", "Dishonest", "Dispensable", "Divided", "Electric", "Elite", "Emerald", "Encircling",
           "Enraged", "Eternal", "Ethereal", "Extra-Small", "Faded", "Fallen", "Famous", "Fast", "Fearless", "Fierce",
           "Flesh", "Fluttering", "Forbidden", "Forgotten", "Forsaken", "Fortunate", "Funny", "Furious", "Golden",
           "Grave", "Grouchy", "Grubby", "Hallowed", "Harmonious", "Heavens", "Hellfire", "Heroic", "Hidden", "High",
           "Holy", "Honest", "Honored", "Hopeful", "Humble", "Icky", "Ill", "Immoral", "Impure", "Independent",
           "Infamous", "Infernal", "Innocent", "Iron", "Itchy", "Jolly", "Joyful", "Joyous", "Jumpy", "Large", "Last",
           "Living", "Lost", "Macabre", "Massive", "Mental", "Mighty", "Mini", "Mislead", "Moonlight", "Mortal",
           "Mysterious", "Mystic", "Mystical", "Nameless", "Nefarious", "Noble", "Nocturnal", "Obscene", "Obscure",
           "Omega", "Ominous", "Open", "Ordained", "Ordinary", "Perished", "Phobic", "Pious", "Power", "Pristine",
           "Profane", "Promised", "Pure", "Purple", "Putrid", "Reckless", "Red", "Rejected", "Resolute", "Revenant",
           "Righteous", "Rising", "Roaring", "Robust", "Rogue", "Rotten", "Royal", "Ruined", "Sacred", "Sacrificed",
           "Scarlet", "Scary", "Scourge", "Sealed", "Searing", "Sedated", "Shaded", "Shadow", "Shameless", "Shattered",
           "Shivering", "Sightless", "Silent", "Sleeping", "Sore", "Super", "Tainted", "Tasty", "Tempest", "Templar",
           "Tricked", "Trusted", "Twilight", "Tyranny", "Ugly", "Unarmed", "Unknown", "Unseen", "Valiant", "Vanquished",
           "Vicious", "Vigorous", "Virtuous", "Vulgar", "Wasted", "Weak", "Wicked", "Winged", "Withered", "World",
           "Worthless", "Wretched", "Wrong", "Grim"]
    nm6 = ["Admirals", "Alliance", "Ancients", "Anomalies", "Apocalypse", "Ashes", "Assailant", "Assassins", "Assault",
           "Berserkers", "Blow", "Brigade", "Brothers", "Butchers", "Champions", "Chaos", "Criminals", "Crossfire",
           "Crusaders", "Death", "Defeat", "Demons", "Devils", "Discipline", "Domination", "Dominion", "Doom", "Dust",
           "Dynasty", "Embers", "End", "Enemy", "Entities", "Executors", "Exiles", "Exterminators", "Fall", "Feast",
           "Force", "Gang", "Gangsters", "Genesis", "Genocide", "Gods", "Grave", "Gunslingers", "Harvesters",
           "Headhunters", "Helix", "Honour", "Hooligans", "Hunters", "Illusions", "Immortals", "Inferno", "Intent",
           "Jackals", "Killers", "Knights", "Legacy", "Legion", "Liquidators", "Mafia", "Maggots", "Moguls",
           "Nightmare", "Noobs", "Oblivion", "Occupation", "Outlaws", "Paradox", "Perception", "Pergatory", "Plague",
           "Power", "Predation", "Predators", "Prestige", "Primeval", "Privilege", "Punished", "Punks", "Rage",
           "Rebels", "Regiment", "Sacrament", "Saints", "Serenity", "Shadow", "Shadows", "Sharpshooters", "Singularity",
           "Slayers", "Soldiers", "Squad", "Strategy", "Supremacy", "Switchblades", "Syndicate", "Synergy", "Thugs",
           "Thunder", "Titans", "Tyranny", "Valor", "Vanguard", "Vanguardians", "Vanguards", "Vengeance", "Veterans",
           "Vigor", "Vigorous", "Vikings", "Vitality", "Voltiac", "Vultures", "War", "Warfare", "Warheads",
           "Widowmakers", "Wolverines", "Wound", "Incarnation"]
